...
<title><%=resourceBundle.getString("index.titolo")%></title>
...
<!-- Plugin CSS -->
<link
	href="/${basePath}/static/vendor/magnific-popup/magnific-popup.css"
	rel="stylesheet">

<!-- Theme CSS - Includes Bootstrap -->
<link href="/${basePath}/static/css/creative.min.css" rel="stylesheet">
...
<body id="page-top">
			...
			<div class="row no-gutters">
				<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box"
						href="/${basePath}/static/img/portfolio/fullsize/1.jpg"> <img
						class="img-fluid"
						src="/${basePath}/static/img/portfolio/thumbnails/1.jpg" alt="">
				...
				<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box"
						href="/${basePath}/static/img/portfolio/fullsize/2.jpg"> <img
						class="img-fluid"
						src="/${basePath}/static/img/portfolio/thumbnails/2.jpg" alt="">
						<div class="portfolio-box-caption">
							<div class="project-category text-white-50">Category</div>
							<div class="project-name">Project Name</div>
						</div>
				...
				<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box"
						href="/${basePath}/static/img/portfolio/fullsize/3.jpg"> <img
						class="img-fluid"
						src="/${basePath}/static/img/portfolio/thumbnails/3.jpg" alt="">
						<div class="portfolio-box-caption">
							<div class="project-category text-white-50">Category</div>
							<div class="project-name">Project Name</div>
						</div>
				...
				<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box"
						href="/${basePath}/static/img/portfolio/fullsize/4.jpg"> <img
						class="img-fluid"
						src="/${basePath}/static/img/portfolio/thumbnails/4.jpg" alt="">
						<div class="portfolio-box-caption">
							<div class="project-category text-white-50">Category</div>
							<div class="project-name">Project Name</div>
						</div>
				...
				<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box"
						href="/${basePath}/static/img/portfolio/fullsize/5.jpg"> <img
						class="img-fluid"
						src="/${basePath}/static/img/portfolio/thumbnails/5.jpg" alt="">
						<div class="portfolio-box-caption">
							<div class="project-category text-white-50">Category</div>
							<div class="project-name">Project Name</div>
						</div>
				...
				<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box"
						href="/${basePath}/static/img/portfolio/fullsize/6.jpg"> <img
						class="img-fluid"
						src="/${basePath}/static/img/portfolio/thumbnails/6.jpg" alt="">
	...
	<script
		src="/${basePath}/static/vendor/magnific-popup/jquery.magnific-popup.min.js"></script>

	<!-- Custom scripts for this template -->
	<script src="/${basePath}/static/js/creative.min.js"></script>
